...
//
// ── Setup (do this ONCE) ────────────────────────────────────────────────
// 1. Create a new script in Scriptable, name it "TrayceWidgetRhythm", and
//    paste this whole file in - it REPLACES pasting TrayceWidgetRhythm.js
//    directly.
...
// 3. Add it to your Home Screen as the Large widget size, same as before.
...
const RAW_URL =
  "https://raw.githubusercontent.com/nebunici-cloud/Align-track/claude/aligners-app-analysis-roadmap-agy1pn/scriptable/TrayceWidgetRhythm.js";
...
async function getScriptCode() {
  ...
  const codePath = fm.joinPath(fm.cacheDirectory(), "trayce-widget-rhythm-remote.js");
  const metaPath = fm.joinPath(fm.cacheDirectory(), "trayce-widget-rhythm-remote.meta");
