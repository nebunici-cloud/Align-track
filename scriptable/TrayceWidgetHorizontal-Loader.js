...
//
// ── Setup (do this ONCE) ────────────────────────────────────────────────
// 1. Create a new script in Scriptable, name it "TrayceWidgetHorizontal",
//    and paste this whole file in - it REPLACES pasting
//    TrayceWidgetHorizontal.js directly.
...
// 3. Add it to your Home Screen as the Medium widget size, same as before.
...
const RAW_URL =
  "https://raw.githubusercontent.com/nebunici-cloud/Align-track/claude/aligners-app-analysis-roadmap-agy1pn/scriptable/TrayceWidgetHorizontal.js";
...
async function getScriptCode() {
  ...
  const codePath = fm.joinPath(fm.cacheDirectory(), "trayce-widget-horizontal-remote.js");
  const metaPath = fm.joinPath(fm.cacheDirectory(), "trayce-widget-horizontal-remote.meta");
